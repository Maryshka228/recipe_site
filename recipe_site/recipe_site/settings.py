...
SECRET_KEY = 'django-insecure-wud&+j6c96)s9@!+12m4yqgem188=6y!z!ai=tff2f&#jp#gm_'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'recipe_db',  # Имя базы
        'USER': 'postgres',   # Пользователь PostgreSQL
        'PASSWORD': '2208',  # Пароль от PostgreSQL
        'HOST': 'localhost',  # Для локальной машины
